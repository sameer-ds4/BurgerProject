...
public class ItemTweenInspector : Editor
{
    ...
    private void DrawComponents()
    {
        ...
        itemTween.delay = EditorGUILayout.Toggle(itemTween.delay);
        GUILayout.EndHorizontal();
    ...
    private void DrawDelayComponents()
    {
        GUILayout.BeginHorizontal();
        GUILayout.Label("Delay Time");
        itemTween.delayTime = EditorGUILayout.FloatField(itemTween.delayTime, GUILayout.Width(250));
        GUILayout.EndHorizontal();
    }
}